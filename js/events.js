...
function installContextMenus() {
  ...
  function() {
    if (brapi.runtime.lastError) handleHeadlessError(brapi.runtime.lastError)
  })
  brapi.menus.create({
    id: "options",
...
function authGoogleTranslate() {
  ...
  brapi.declarativeNetRequest.updateDynamicRules({
    addRules: [{
      id: 1,
      condition: {
        urlFilter: config.gtranslatePerms.origins[0],
